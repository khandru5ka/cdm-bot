...
async def cmd_start(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if is_registered(user.id):
        ...
        await update.message.reply_text(
            ...
            "Откройте мир особых привилегий для наших самых дорогих гостей.<br>"
            "Сгенерируйте QR-код, предъявите его на кассе и получите индивидуальную скидку до 30%. Предложения будут обновляться.<br>""
